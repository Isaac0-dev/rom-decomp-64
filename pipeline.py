...
class ExtractionPipeline:
    ...
    def pass_init(self) -> None:
        ...
        hacker_sm64_bytes = (
            ...
            b"\x45\x46\x00\x00\x00\x00\x30\x31\x32\x33\x34\x35\x36\x37"
            b"\x38\x39\x61\x62\x63\x64\x65\x66\x00\x00\x00\x00\x30\x30"
            b"\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30"
            b"\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30\x30"
            b"\x30\x30\x00\x00\x00\x00\x20\x20\x20\x20\x20\x20\x20\x20"
            b"\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20"
            b"\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20"
        )
        hacker_sm64_results = find_all_needles_in_haystack(rom_data, hacker_sm64_bytes)
        if hacker_sm64_results:
            hack_type = "HackerSM64"
